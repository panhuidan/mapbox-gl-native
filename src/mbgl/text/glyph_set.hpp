...
private:
    float determineIdeographicLineWidth(const std::u16string& logicalInput, const float spacing, float maxWidth) const;
    std::set<int32_t> determineLineBreaks(const std::u16string& logicalInput, const float spacing, float maxWidth) const;
