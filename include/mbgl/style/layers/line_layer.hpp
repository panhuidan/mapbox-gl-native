...
public:
    ...
    DataDrivenPropertyValue<float> getLineWidth(const optional<std::string>& klass = {}) const;
    void setLineWidth(DataDrivenPropertyValue<float>, const optional<std::string>& klass = {});
