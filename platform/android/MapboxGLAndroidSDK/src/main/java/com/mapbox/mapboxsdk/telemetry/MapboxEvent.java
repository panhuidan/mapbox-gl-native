...
public class MapboxEvent implements Serializable {
     ...
     *
     * @param mapboxMap   MapboxMap used for the gesture
     ...
     */
    public static void trackGestureEvent(@NonNull MapboxMap mapboxMap, @NonNull String gestureId, float xCoordinate, float yCoordinate) {
        LatLng tapLatLng = mapboxMap.getProjection().fromScreenLocation(new PointF(xCoordinate, yCoordinate));
     ...
     */
    public static void trackGestureDragEndEvent(@NonNull MapboxMap mapboxMap, float xCoordinate, float yCoordinate) {
        LatLng tapLatLng = mapboxMap.getProjection().fromScreenLocation(new PointF(xCoordinate, yCoordinate));
